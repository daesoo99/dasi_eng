/**
 * SmartReviewService - SSOT 백엔드 SRS 서비스
 * 
 * 🎯 역할: 프론트엔드 SRS 시스템과 연동하는 백엔드 SSOT
 * ✅ 기능: SuperMemo SM-2+ 알고리즘, 개인화, Firebase 통합
 * 🔗 연동: useSRSEngine.ts (프론트엔드) ↔ SmartReviewService (백엔드)
 * 
 * 2025-01-12: 백엔드 SRS 시스템의 단일 진실 원본(SSOT)으로 확정
 */
